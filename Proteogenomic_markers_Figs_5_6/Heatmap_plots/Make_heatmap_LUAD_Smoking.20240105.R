...
column_ha = HeatmapAnnotation(MutCount = anno_barplot(col_annot$Mut_count,bar_width = 0.5, height = unit(1, "cm")),
Smoking_MutSign = anno_points(col_annot$Count_Smoking_MutSignature, 
...
split_column=factor(col_annot$Subtype_by_markers,levels=c('Smoking_low','Smoking_high'))
